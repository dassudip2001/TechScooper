    ...
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900">
      ...
      <main className="container mx-auto px-4 md:px-6 py-8 md:py-12">
        <div className="mb-8 md:mb-12 text-center md:text-left">
          <h1 className="text-4xl md:text-5xl font-black tracking-tight mb-4">
            Curated <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600">Comfort.</span>
          </h1>
          <p className="text-lg text-slate-500 max-w-2xl">
            Discover our premium selection of modern furniture, designed to elevate your living space with minimalist elegance and timeless quality.
          </p>
        </div>
      ...
      <footer className="bg-white border-t border-slate-200 mt-24 py-12">
        <div className="container mx-auto px-4 md:px-6 text-center text-slate-500 text-sm">
          <p>&copy; {new Date().getFullYear()} ModernFurnish. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
